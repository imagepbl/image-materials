...
from imagematerials.fossil_fuels.preprocessing.main_final import get_preprocessing_data_extraction as prep_ff_extr
from imagematerials.fossil_fuels.preprocessing.main_final import get_preprocessing_data_processing as prep_ff_proc
from imagematerials.fossil_fuels.preprocessing.main_final import get_preprocessing_data_pipelines as prep_ff_pipe
from imagematerials.fossil_fuels.preprocessing.main_final import get_preprocessing_data_transport as prep_ff_trp
from imagematerials.fossil_fuels.preprocessing.main_final import get_preprocessing_data_storage as prep_ff_str
