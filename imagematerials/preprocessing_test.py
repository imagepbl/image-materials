...
from imagematerials.fossil_fuels.preprocessing.main_test import get_preprocessing_data_extraction as prep_ff_extr
from imagematerials.fossil_fuels.preprocessing.main_test import get_preprocessing_data_processing as prep_ff_proc
from imagematerials.fossil_fuels.preprocessing.main_test import get_preprocessing_data_pipelines as prep_ff_pipe
from imagematerials.fossil_fuels.preprocessing.main_test import get_preprocessing_data_transport as prep_ff_trp
from imagematerials.fossil_fuels.preprocessing.main_test import get_preprocessing_data_volume as prep_ff_vol
...
def _get_fossilfuels_prep_data(base_dir, climate_policy_scenario_dir, circular_economy_scenario_dirs, scenario, year_start, year_end, year_out):
    ...
    with warnings.catch_warnings():
        ...
        prep_data_volume = prep_ff_vol(base_dir, climate_policy_config, circular_economy_config, scenario, year_start, year_end, year_out)
        ...
        prep_data = {
            ...
            "prep_data_volume": prep_data_volume
...
def _get_fossilfuels_sector(prep_data):
    ...
    sec_ff_vol = Sector("ff_vol", prep_data["prep_data_volume"])

    sec_ff = [sec_ff_extr, sec_ff_proc, sec_ff_pipe, sec_ff_trp, sec_ff_vol]
