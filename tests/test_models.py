...
from imagematerials.model import GenericMaterials, GenericStocks, MaterialIntensities, Rest_Of
...
@mark.parametrize(
    "model_class", [GenericStocks, GenericMaterials, MaterialIntensities, Rest_Of,
                    Battery]
)
