...
def get_preprocessing_data_stor(path_base: str, climate_policy_config: dict, circular_economy_config: dict):
    ...
    lifetimes = pd.read_csv(path_external_data_standard / 'storage_and_ev_battery_lifetimes.csv', 
                            usecols=["Time", "sub_technology", "value"])

    # material intensities in kg/kWh
    material_intensities = pd.read_csv(path_external_data_standard / 'storage_and_ev_battery_material_intensities.csv', 
