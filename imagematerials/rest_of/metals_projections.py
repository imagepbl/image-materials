...
def steel_projection(scenario: str):
    ...
    high = ['class_ 19', 'class_ 20', 'class_ 23']
    ...
    fit_not_good = ['class_ 6', 'class_ 10', 'class_ 14', 
                    'class_ 15', "class_ 18"]
    ...
    rest = [r for r in rest if r not in (low+class_1+high+very_low+too_low+fit_not_good)]
