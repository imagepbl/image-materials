...
EV_BATTERY_TYPES = ["low-nickel", "high-nickel", "LFP", "Na-ion"] # move to constants files
...
# market_share_EVs = normalize_selected_techs(storage_market_share_interp, EV_BATTERY_TYPES, dim_type="BatteryType") # TODO: this should be done differently as market shares of EV batteries probably differ from their market shares in total storage market
...
prep_data["material_fractions"] = material_intensities_da_interp
