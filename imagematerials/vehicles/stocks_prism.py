...
class VehicleStocks(prism.Model):
    ...
    def _calculate_total_vehicles_by_type(self, time: prism.Time):
        ...
        # if "Medium Freight Trucks" in tkms_year.coords.get("FreightType") and \
        #    "Heavy Freight Trucks" in tkms_year.coords.get("FreightType"):
        ...
        #     self.total_vehicles.loc[dict(Mode="Medium Freight Trucks")] = (self.conversion_factor_tkms["Medium Freight Trucks"].values * 
        #                                                                   trucks_MFT_tkm.values)
        #     self.total_vehicles.loc[dict(Mode="Heavy Freight Trucks")] = (self.conversion_factor_tkms["Heavy Freight Trucks"].values * 
        #                                                                  trucks_HFT_tkm.values)
        #     self.total_vehicles.loc[dict(Mode="Light Commercial Vehicles")] = (self.conversion_factor_tkms["Light Commercial Vehicles"].values * 
